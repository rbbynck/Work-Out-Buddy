...
public class Activity_Exercise_Plan_Lose_Day_Exercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__exercise__plan__lose__day__exercise);
        setTitle("");
    ...
    public void database() {
        int id;
        Cursor cursor = db.viewLose(getIntent().getIntExtra("EXTRA_DAY", 0));
    ...
    public void initialization() {
        volume = findViewById(R.id.exercise_plan_lose_exercise_volume);
        rest_layout = findViewById(R.id.exercise_plan_lose_day__exercise_rest_layout);
        rest_time = findViewById(R.id.exercise_plan_lose_day__exercise_rest_time);
        rest_skip = findViewById(R.id.exercise_plan_lose_day__exercise_rest_skip);
        rest_time_text = findViewById(R.id.exercise_plan_lose_day__exercise_rest_nexttime);
        rest_next_title = findViewById(R.id.exercise_plan_lose_day__exercise_rest_next);
        rest_image = findViewById(R.id.exercise_plan_lose_day__exercise_rest_image);
        rest_title = findViewById(R.id.exercise_plan_lose_day__exercise_rest_title);
        rest_animation = (AnimationDrawable) rest_image.getBackground();
        rest_animation.start();
        exercise_image = findViewById(R.id.exercise_plan_lose_day__exercise_exercise_image);
        exercise_layout = findViewById(R.id.exercise_plan_lose_day__exercise_exercise_layout);
        exercise_button = findViewById(R.id.exercise_plan_lose_day__exercise_exercise_button);
        exercise_next = findViewById(R.id.exercise_plan_lose_day__exercise_exercise_next);
        exercise_prev = findViewById(R.id.exercise_plan_lose_day__exercise_exercise_prev);
        exercise_time_text = findViewById(R.id.exercise_plan_lose_day__exercise_exercise_time);
        exercise_title = findViewById(R.id.exercise_plan_lose_day__exercise_exercise_title);
        exercise_progress = findViewById(R.id.exercise_plan_lose_day__exercise_exercise_progressbar);
        readytogo_text = findViewById(R.id.exercise_plan_lose_day__exercise_readytogo_time);
        readytogo_skip = findViewById(R.id.exercise_plan_lose_day__exercise_readytogo_skip);
        readytogo_layout = findViewById(R.id.exercise_plan_lose_day__exercise_readytogo_layout);
        readytogo_image = findViewById(R.id.exercise_plan_lose_day__exercise_readytogo_image);
        ...
        readytogo_exercise = findViewById(R.id.lose_day_ready_to_go_exercise);
        ...
        exercise_timer = new CountDownTimer(time, 1000) {
            ...
            public void onFinish() {
                ...
                if (exerciseNo == total_exercise) {
                    ...
                    intent = new Intent(Activity_Exercise_Plan_Lose_Day_Exercise.this, Activity_Exercise_Congratulations.class);
    ...
    public void ExerciseChange(int exerciseNumber) {
        ...
        for (int i = 0; i < total_exercise; i++) {
            if (currentExercise == (i + 1)) {
                ...
                if (drawable[i] != R.drawable.exercise_icon_lose_plank) {
                    exercise_animation = (AnimationDrawable) exercise_image.getBackground();
                    exercise_animation.start();
                    rest_animation = (AnimationDrawable) rest_image.getBackground();
                    rest_animation.start();
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("Quit", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                db.addWorkoutHistory(calories);
                Activity_Exercise_Plan_Lose_Day_Exercise.super.onBackPressed();
            }
        });
    ...
    public void toolBar() {
        Toolbar toolbar = findViewById(R.id.toolBar_exercise_plan_lose_day_exercise);
